...
public class CircleProgressBar extends ProgressBar {
    ...
    private static final String COLOR_FFD3D3D5 = "#f0f0f0";
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mLineWidth = a.getDimensionPixelSize(R.styleable.CircleProgressBar_line_width, Tools.dip2px(getContext(), DEFAULT_LINE_WIDTH));
        mProgressTextSize = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_text_size, Tools.dip2px(getContext(), DEFAULT_PROGRESS_TEXT_SIZE));
        mProgressStrokeWidth = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_stroke_width, Tools.dip2px(getContext(), DEFAULT_PROGRESS_STROKE_WIDTH));
    ...
    private void drawSolidLineProgress(Canvas canvas) {
        canvas.drawArc(mProgressRectF, DEFAULT_START_DEGREE, 360.0f, false, mProgressBackgroundPaint);
        canvas.drawArc(mProgressRectF, DEFAULT_START_DEGREE, 360.0f * (direction)*getProgress() / getMax(), false, mProgressPaint);
    }
